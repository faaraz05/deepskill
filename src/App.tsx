...
import { BriefcaseIcon, GraduationCapIcon, TrendingUpIcon, UsersIcon, Clock, BookOpen, ArrowRight, ChevronLeft, ChevronRight } from 'lucide-react';
              ...
              <div className="overflow-hidden" ref={emblaRef}>
                <div className="flex -ml-4">
                  {simulations.map((sim, index) => (
                    <div key={index} className="min-w-[calc(33.333%-16px)] pl-4">
                      <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden h-full flex flex-col">
                        ...
                        <div className="p-6 flex flex-col flex-1">
                          ...
                          <div className="flex items-center justify-between pt-4 border-t border-gray-100 mt-4">
                            ...
                            {/* {sim.path ? (
                                <Link to={sim.path} className="text-blue-600 hover:text-blue-700 font-medium">
                                  Start
                                </Link>
                              ) : (
